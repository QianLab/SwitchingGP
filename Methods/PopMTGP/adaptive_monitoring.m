function [context_pred, alpha_prob, feature_sets] = adaptive_monitoring(signal, time, model, pred_lag, max_duration, feature_subsets)
...
feature_sets = zeros(time_length, 1);
...
feature_sets(t) = 1;
log_alpha(t, :, d) = -emissionMTGPFeat(signal(t, :), time(t), feature_model, gp_model, feature_sets(t), feature_subsets);
