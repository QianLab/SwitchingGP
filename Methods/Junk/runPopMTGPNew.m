...
% signal_means = mean(signals_train);
% signals_train = signals_train - signal_means;
% signals_test = signals_test - signal_means;
...
% 		signals_training{j}{i} = signals_training{j}{i}(:, 1:10);
...
% 		signals_testing{j}{i} = signals_testing{j}{i}(:, 1:10);
